...
<Screencast
  id="1096177694"
  hash="f94055badf"
  title="Installez et paramétrez l’extension DevContainer"
/>
...
<Screencast
  id="1096177902"
  hash="d6575a760b"
  title="Découvrez les modifications apportées au projet fil rouge"
/>
...
<Screencast
  id="1096177977"
  hash="22f860521c"
  title="Exercez-vous — Développez dans un environnement conteneurisé"
/>
