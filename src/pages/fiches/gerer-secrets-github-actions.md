...
- **Les secrets ne sont pas disponibles pour les pull requests venant d'un
  ...
  pour voler vos secrets. Prévoyez vos workflows en conséquence — le choix du
  déclencheur compte, et c'est justement le sujet de la fiche
...
- à mettre tout ça en pratique avec la fiche
  ...
   ;
- à voir comment le problème se pose côté conteneur avec
  [Comment bien gérer les secrets en Docker ?](/fiches/bien-gerer-secrets-docker)
  — mêmes réflexes, autre terrain ;
- à (re)découvrir
