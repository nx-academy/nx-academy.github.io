...
const newAprilTasks: LogTasks = {
  ...
  tasks: [
    ...
    {
      kind: "in-progress",
      content: "Je suis en train de préparer un nouveau format cette fois plus orienté vidéo. Je pense shooter la première le premier week-end d'avril. Je reviendrais dessus plus tard."
    },
    {
      kind: "in-progress",
      content: "Je suis en train de faire une grosse prise en main de Claude Code et de Codex sur des projets persos. J'en profiterais certainement pour faire quelques fiches techniques dessus."
    },
    {
      kind: "fix",
      content: "Pas mal de petits fixes et de mises à jour de sécurité. Le mois de Mars a été un peu infernal en terme de brèches informatiques."
    }
  ]
}
