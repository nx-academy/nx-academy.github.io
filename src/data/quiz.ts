...
export const QUIZZES: readonly QuizMeta[] = [
  ...
  },
  {
    ...
    description: "Un quiz pour tester votre maîtrise avancée de Docker. Vous explorerez des notions complexes comme les réseaux personnalisés, les layers d’image, le build multi-stage ou encore la gestion fine des volumes et des ressources. Ce quiz met aussi l’accent sur les bonnes pratiques et la compréhension du fonctionnement interne de Docker. À réserver à ceux qui veulent aller au-delà des bases et optimiser leurs conteneurs comme des pros.",
    level: "Difficile",
    imgSrc: "/misc/quiz-hero.webp",
