...
const DOCKER_COURSE_URL =
  "/cours/docker-et-docker-compose/chapitres/installation-et-configuration-docker";
const CI_CD_COURSE_URL =
  "/cours/ci-cd-github-actions/chapitres/decouverte-concepts-ci-cd";
